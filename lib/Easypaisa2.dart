...
class Easypaisa2 extends StatelessWidget {
  Easypaisa2({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(181.0, 310.0),
            child: SizedBox(
              width: 985.0,
              height: 803.0,
              child: Text(
                'You will be redirected to easypaisa page to complete the payment. Make the payment within 60 seconds of clicking the pay securely button.\n\nTelenor Subscribers can open an account simply by dialing *786#\n\nNon-Telenor customers can open an account and pay via Easypaisa account using the Easypaisa App.',
                style: TextStyle(
                  fontFamily: 'Segoe UI',
                  fontSize: 45,
