...
class HomeTimelineSearchClicked extends StatelessWidget {
  HomeTimelineSearchClicked({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(229.0, 210.0),
            child: Container(
              width: 988.0,
              height: 93.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(47.0),
                border: Border.all(width: 2.0, color: const Color(0x993d7eff)),
              ),
            ),
          ),
          Transform.translate(
          ...
          Transform.translate(
            offset: Offset(-108.0, 620.0),
            child:
                // Adobe XD layer: 'Till-retail-payment…' (shape)
                Container(
              width: 2158.0,
              height: 589.0,
              decoration: BoxDecoration(
