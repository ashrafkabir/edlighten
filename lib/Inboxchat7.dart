...
class Inboxchat7 extends StatelessWidget {
  Inboxchat7({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(467.0, 49.0, 310.0, 59.0),
                  size: Size(1242.0, 159.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Transform.translate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(15.0),
                color: const Color(0xffffffff),
                border: Border.all(width: 1.0, color: const Color(0xff5e5e5e)),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(790.0, 1285.0),
            child: Container(
              width: 359.0,
              height: 700.0,
              decoration: BoxDecoration(
...
const String _svg_i50inu =
    '<svg viewBox="45.5 1218.5 1151.1 856.4" ><path transform="translate(45.5, 1218.53)" d="M 0 0 L 1151.075805664062 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(45.5, 2074.93)" d="M 0 0 L 1151.075805664062 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
