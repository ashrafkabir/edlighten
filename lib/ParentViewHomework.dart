...
class ParentViewHomework extends StatelessWidget {
  ParentViewHomework({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(427.0, 49.0, 385.0, 59.0),
                  size: Size(1242.0, 159.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
