...
import 'package:EDLIGHTEN/Screens/chat/ChatView.dart';
              ...
              SimpleDialogOption(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Text(
                      'CANCEL',
                      style: TextStyle(color:  HexToColor(MyConstants.blueClr), fontWeight: FontWeight.bold),
                    )
                  ],
                ),
              ),
...
//              ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        child: Text(
                          ...
                          style: TextStyle(color:  HexToColor(MyConstants.greyClr),fontSize: 10),
                        ),
                        alignment: Alignment.centerLeft,
              ...
              Column(
                ...
                children: <Widget>[
                  Text('12 DEC',style: TextStyle(fontSize: 12,color:  HexToColor(MyConstants.greyClr),),),
                  Text('11:10 PM',style: TextStyle(fontSize: 12,color:  HexToColor(MyConstants.greyClr),),),
