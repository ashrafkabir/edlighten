...
//            width: 200.0,
       constraints: BoxConstraints(maxWidth: MyConstants.width*0.7),
            decoration: BoxDecoration(color: HexToColor(MyConstants.greyClr), borderRadius: BorderRadius.circular(8.0)),
            margin: EdgeInsets.only(bottom: isLastMessageRight(index) ? 20.0 : 10.0, right: 10.0),
          ),
          index==1
              ? Material(
            child: Icon(Icons.person_outline,color: HexToColor(MyConstants.greyClr,),size: 30,),
...
//                  width: 200.0,
                  decoration: BoxDecoration(color: HexToColor(MyConstants.blueClr), borderRadius: BorderRadius.circular(8.0)),
...
//          buildLoading()
  ...
  Widget buildSticker() {
    return Container(
      ...
      decoration: BoxDecoration(border: Border(top: BorderSide(color: HexToColor(MyConstants.greyClr), width: 0.5)), color: Colors.white),
...
//                  hintStyle: TextStyle(color: greyColor),
          ...
          Material(
            child: Container(
              ...
              child: Icon(Icons.send,color: HexToColor(MyConstants.blueClr),),
